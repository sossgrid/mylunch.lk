<?php
    ...
    Carbite::GET("/@componentName/service/@handlerName/*route", [$componentManager,"HandleService"], [[$virtualFirewall,"CheckAuthentication"]]);
    Carbite::POST("/@componentName/service/@handlerName", [$componentManager,"HandleService"], [[$virtualFirewall,"CheckAuthentication"]]);
    Carbite::POST("/@componentName/service/@handlerName/*route", [$componentManager,"HandleService"], [[$virtualFirewall,"CheckAuthentication"]]);
