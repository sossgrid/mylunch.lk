...
class SOSSData {
    ...
    private static function callRest($host, $className, $jsonObj = null, $method="GET"){
        $ch = curl_init();
        $url = OS_URL . "/$className";
        curl_setopt ($ch, CURLOPT_URL, $url);
        curl_setopt ($ch, CURLOPT_HTTPHEADER, array("Content-Type: application/json", "Host: $host"));
