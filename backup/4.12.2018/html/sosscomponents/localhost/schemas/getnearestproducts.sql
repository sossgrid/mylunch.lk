...
DECLARE var_lan1 decimal(10,8);
DECLARE var_lan2 decimal(10,8);
DECLARE var_lat1 decimal(10,8);
DECLARE var_lat2 decimal(10,8);
SET var_lan1 =param_lng-(1/111*10);
SET var_lan2 =param_lng+(1/111*10);
SET var_lat1 =param_lat-(1/111*10);
SET var_lat2 =param_lat+(1/111*10);
